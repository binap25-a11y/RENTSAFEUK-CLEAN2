...
import { ArrowLeft, Loader2, CalendarIcon, User, Shield, AlertTriangle, Download } from 'lucide-react';
...
export default function ViewInspectionPage() {
  ...
  if (isLoadingInspection || isLoadingProperty) {
    return <div className="flex h-64 items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-muted-foreground" /></div>;
  }

  if (inspectionError) {
    return <div className="text-center text-destructive">Error loading inspection: {inspectionError.message}</div>;
  }
