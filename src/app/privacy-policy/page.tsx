    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 pt-6">
          ...
          <p>
            Welcome to Maintain UK. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our application. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the application.
          </p>
