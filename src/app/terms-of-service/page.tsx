    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl">
      ...
      <Card>
        ...
        <CardContent className="space-y-4 pt-6">
          ...
          <p>
            By creating an account and using the Maintain UK application ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of the terms, then you may not access the Service.
          </p>
