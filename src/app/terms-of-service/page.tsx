    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl text-left">
      ...
      <Card className="border-none shadow-lg">
        <CardHeader className="bg-primary/5 border-b">
          <CardTitle className="text-xl">RentSafeUK Terms and Conditions</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 pt-8 pb-10">
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">1. Acceptance of Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">2. Description of Service</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">3. User Accounts</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">4. Acceptable Use</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">5. Landlord and Tenant Responsibilities</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
              The platform does not act as a legal intermediary between landlords and tenants. All agreements, responsibilities, and obligations between users remain their own.
            </p>
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">6. Content and Data</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">7. Service Availability</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">8. Limitation of Liability</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">9. Termination</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">10. Changes to Terms</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="font-bold text-lg text-primary">11. Governing Law</h2>
            <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <section className="space-y-3 border-t pt-6">
            <h2 className="font-bold text-lg text-primary">12. Contact</h2>
